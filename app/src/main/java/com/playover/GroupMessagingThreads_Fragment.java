...
public class GroupMessagingThreads_Fragment extends Fragment {

    protected List<String> messageThreads = new ArrayList<>();
    private RecyclerView recyclerView;
    private GroupMessagingThreads_Fragment.ContentAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_groupmessagingthreads, container, false);
    ...
    private void getMessageThreads() {
        userViewModel.getUser(authVm.getUser().getUid(),
                (Person user) -> {
                    ...
                    adapter = new GroupMessagingThreads_Fragment.ContentAdapter(recyclerView.getContext(), messageThreads);
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<GroupMessagingThreads_Fragment.ViewHolder> {
        ...
        @Override
        public GroupMessagingThreads_Fragment.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater l = LayoutInflater.from(parent.getContext());
            View v = l.inflate(R.layout.thread_list, parent, false);
            return new GroupMessagingThreads_Fragment.ViewHolder(l, parent);
        }


        @Override
        public void onBindViewHolder(GroupMessagingThreads_Fragment.ViewHolder holder, final int position) {
